...
// Use a default model for local dev if not set
const GEMINI_MODEL = process.env.GEMINI_MODEL || (process.env.NODE_ENV === 'production' ? 'gemini-2.5-flash' : 'gemini-1.5-pro');
